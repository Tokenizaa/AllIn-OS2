...
// New interfaces for machine auxiliary tables
...
// New interfaces for process auxiliary tables
...
// Capacity History exports
export const getCapacityHistory = (data: unknown) => industrialService.getCapacityHistory((data as { capacityId?: string }).capacityId);
export const getCapacityHistoryById = (data: unknown) => industrialService.getCapacityHistoryById((data as { id: string }).id);
export const createCapacityHistory = (data: unknown) => industrialService.createCapacityHistory(data as Partial<CapacityHistory>);
export const updateCapacityHistory = (data: unknown) => {
  const { id, ...rest } = data as { id: string } & Partial<CapacityHistory>;
  return industrialService.updateCapacityHistory(id, rest);
};
export const deleteCapacityHistory = (data: unknown) => industrialService.deleteCapacityHistory((data as { id: string }).id);
export const getCapacityHistoryByCapacityId = (data: unknown) => industrialService.getCapacityHistoryByCapacityId((data as { capacityId: string }).capacityId);
export const getCapacityHistoryByDateRange = (data: unknown) => industrialService.getCapacityHistoryByDateRange((data as { startDate: string; endDate: string }).startDate, (data as { startDate: string; endDate: string }).endDate);
export const getCapacityHistoryByMachineId = (data: unknown) => industrialService.getCapacityHistoryByMachineId((data as { machineId: string }).machineId);
export const calculateAverageEfficiency = (data: unknown) => industrialService.calculateAverageEfficiency((data as { capacityId: string }).capacityId);
