...
export class StoreMapper {
   ...
   */
  static fromAllin(allinStore: any): LocalStore {
    return {
   ...
   */
  static fromAllinArray(allinStores: any[]): LocalStore[] {
   ...
   */
  static needsSync(localStore: LocalStore, allinStore: any): boolean {
    ...
    if (localStore.nome !== allinStore.nome) return true;
    if (localStore.ativo !== allinStore.ativo) return true;
