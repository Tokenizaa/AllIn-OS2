...
import type { AllInDistribuidorAtivacoesMensais } from '../../allin/dto/allin.dto';
...
export class ActivationMapper {
   ...
   */
  static fromAllin(allinActivation: AllInDistribuidorAtivacoesMensais): LocalActivation {
    return {
   ...
   */
  static fromAllinArray(allinActivations: AllInDistribuidorAtivacoesMensais[]): LocalActivation[] {
   ...
   */
  static needsSync(localActivation: LocalActivation, allinActivation: AllInDistribuidorAtivacoesMensais): boolean {
    ...
    if (localActivation.quantidade_ativacoes !== allinActivation.quantidade_ativacoes) return true;
    if (localActivation.valor_total !== allinActivation.valor_total) return true;
