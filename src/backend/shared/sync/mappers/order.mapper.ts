...
import type { AllInPedido } from '../../allin/dto/allin.dto';
...
export class OrderMapper {
   ...
   */
  static fromAllin(allinOrder: AllInPedido): LocalOrder {
    return {
   ...
   */
  static fromAllinArray(allinOrders: AllInPedido[]): LocalOrder[] {
   ...
   */
  static needsSync(localOrder: LocalOrder, allinOrder: AllInPedido): boolean {
    ...
    if (localOrder.status !== allinOrder.status) return true;
    if (localOrder.pagamento_confirmado !== allinOrder.pagamento_confirmado) return true;
