...
import type { AllInDistribuidorQualificacaoAtual } from '../../allin/dto/allin.dto';
...
export class QualificationMapper {
   ...
   */
  static fromAllin(allinQualification: AllInDistribuidorQualificacaoAtual): LocalQualification {
    return {
   ...
   */
  static fromAllinArray(allinQualifications: AllInDistribuidorQualificacaoAtual[]): LocalQualification[] {
   ...
   */
  static needsSync(localQualification: LocalQualification, allinQualification: AllInDistribuidorQualificacaoAtual): boolean {
    ...
    if (localQualification.qualificacao_nome !== allinQualification.qualificacao_nome) return true;
    if (localQualification.nivel !== allinQualification.nivel) return true;
