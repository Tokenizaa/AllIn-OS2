...
export const Route = createFileRoute("/distributor/store")({ component: StorePage });
            ...
            <div key={prod.id} className="rounded-2xl border border-border/65 bg-[#090d16]/80 overflow-hidden flex flex-col justify-between">
              <div className="p-5 space-y-4">
                ...
                <div className="flex justify-between items-baseline pt-4 border-t border-border/50">
                  <strong className="text-lg font-extrabold text-white">{formatBRL(Number(prod.price || 0))}</strong>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <StatCard label="Ticket médio" value={formatBRL(storeAnalytics.ticket_medio)} delta={0} accent="warning" />
      </div>
