...
import { ShoppingCart, Package, Heart, Settings, LogOut, User, Mail, Phone, MapPin, CreditCard } from "lucide-react";
...
export const Route = createFileRoute("/minha-conta")({
  component: MinhaContaPageSecure,
});

function MinhaContaPageSecure() {
  return (
