...
import { createRootRouteWithContext, useRouter, Link, HeadContent, Outlet, Scripts, createFileRoute, lazyRouteComponent, useLocation, useParams, notFound, createRouter } from "@tanstack/react-router";
import { jsx, jsxs, Fragment } from "react/jsx-runtime";
import * as React from "react";
import { createContext, useState, useEffect, useContext, useCallback, useMemo } from "react";
import { s as supabase } from "./supabase-client-BdpvIS_G.js";
import { Sun, Moon, X, Menu, ChevronRight, ShoppingBag, Trash2, ArrowRight, QrCode, CreditCard, CheckCircle2, ShieldCheck } from "lucide-react";
...
var UserRole = /* @__PURE__ */ ((UserRole2) => {
  UserRole2["ADMIN_MASTER"] = "admin_master";
  UserRole2["GESTAO_ADMIN"] = "gestao_admin";
  UserRole2["FINANCEIRO"] = "financeiro";
  UserRole2["SUPORTE"] = "suporte";
  UserRole2["LOGISTICA"] = "logistica";
  UserRole2["MARKETING"] = "marketing";
  UserRole2["ANALYTICS"] = "analytics";
  UserRole2["AUDITOR"] = "auditor";
  UserRole2["OPERADOR"] = "operador";
  UserRole2["DISTRIBUIDOR"] = "distribuidor";
  UserRole2["AFILIADO"] = "afiliado";
  UserRole2["CLIENTE_FINAL"] = "cliente_final";
  return UserRole2;
})(UserRole || {});
...
class SupabaseService {
  ...
  static async fetchDistributorProfile(userId) {
    try {
      const { data, error } = await supabase.from("customers").select("id, user_id, usuario, id_comprador, patrocinador_comprador, qualification, status, metadata").eq("user_id", userId).maybeSingle();
      if (error) {
...
const referralTrackingService = {
  ...
  getReferralTracking: async (userId) => {
    const { data, error } = await supabase.from("referral_tracking").select("*").eq("user_id", userId).maybeSingle();
    if (error) {
...
const AuthProvider = ({ children }) => {
  ...
  const [activeReferralMetadata, setActiveReferralMetadata] = useState(null);
...
const DistributorContext = createContext(void 0);
const DistributorProvider = ({
  children,
  initialSlug
}) => {
  const [slug, setSlug] = useState(() => initialSlug || "");
  const [currentDistributor, setCurrentDistributor] = useState(() => emptyDistributor(initialSlug || ""));
  const [loading, setLoading] = useState(true);
  useEffect(() => {
    (async () => {
      setLoading(true);
  ...
  return /* @__PURE__ */ jsx(DistributorContext.Provider, { value: { currentDistributor, setDistributorBySlug: setSlug, loading }, children });
};
...
const StoreSettingsContext = createContext(void 0);
const StoreSettingsProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsx(StoreSettingsContext.Provider, { value: { settings, updateSettings, whatsapp: settings.whatsapp, sponsorLink: settings.sponsorLink }, children });
};
...
const CartProvider = ({ children }) => {
  ...
  const removeItem = useCallback(async (cartItemId, _selectedSize) => {
    if (!user?.id) return;
    setLoading(true);
    try {
      await cartService.removeItem(cartItemId);
  ...
  const updateQuantity = useCallback(async (cartItemId, selectedSizeOrQuantity, quantity) => {
    if (!user?.id) return;
...
const ProductsContext = createContext(void 0);
const ProductsProvider = ({ children }) => {
  ...
  const getProductsByCategory = useCallback((categoryName, limit = 4) => {
  ...
  return /* @__PURE__ */ jsx(ProductsContext.Provider, { value: contextValue, children });
};
const useProducts = () => {
...
const StyleProvider = ({
  ...
  return /* @__PURE__ */ jsx(StyleContext.Provider, { value: mergedStyles, children });
};
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxs("html", { lang: "en", children: [
    ...
    /* @__PURE__ */ jsxs("body", { className: "dark bg-[#06080d] text-white", children: [
      /* @__PURE__ */ jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsx(ThemeProvider, { children: /* @__PURE__ */ jsx(AuthProvider, { children: /* @__PURE__ */ jsx(DistributorProvider, { children: /* @__PURE__ */ jsx(StoreSettingsProvider, { children: /* @__PURE__ */ jsx(CartProvider, { children: /* @__PURE__ */ jsx(ProductsProvider, { children: /* @__PURE__ */ jsx(StyleProvider, { children: /* @__PURE__ */ jsx(Outlet, {}) }) }) }) }) }) }) }) }),
      /* @__PURE__ */ jsx(Scripts, {})
    ] })
  ] });
}
const $$splitComponentImporter$I = () => import("./seja-distribuidor-D5ZBDcrT.js");
const Route$J = createFileRoute("/seja-distribuidor")({
  component: lazyRouteComponent($$splitComponentImporter$I, "component")
});
const $$splitComponentImporter$H = () => import("./redefinir-senha-QiJErt6w.js");
const Route$I = createFileRoute("/redefinir-senha")({
  component: lazyRouteComponent($$splitComponentImporter$H, "component")
});
const $$splitComponentImporter$G = () => import("./recuperar-senha-Dt02yEHc.js");
const Route$H = createFileRoute("/recuperar-senha")({
  component: lazyRouteComponent($$splitComponentImporter$G, "component")
});
const $$splitComponentImporter$F = () => import("./office-ilgdjI0B.js");
const Route$G = createFileRoute("/office")({
  component: lazyRouteComponent($$splitComponentImporter$F, "component")
});
const $$splitComponentImporter$E = () => import("./loja-ChPyDVVC.js");
const Route$F = createFileRoute("/loja")({
  component: lazyRouteComponent($$splitComponentImporter$E, "component")
});
const $$splitComponentImporter$D = () => import("./login-DidoftfU.js");
const Route$E = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$D, "component")
});
const $$splitComponentImporter$C = () => import("./doencas-BoUhOtWI.js");
const Route$D = createFileRoute("/doencas")({
  component: lazyRouteComponent($$splitComponentImporter$C, "component")
});
const $$splitComponentImporter$B = () => import("./checkout-DSRV8ifs.js");
const Route$C = createFileRoute("/checkout")({
  component: lazyRouteComponent($$splitComponentImporter$B, "component")
});
const $$splitComponentImporter$A = () => import("./cadastro-DP-YbKbu.js");
const Route$B = createFileRoute("/cadastro")({
  component: lazyRouteComponent($$splitComponentImporter$A, "component")
});
const $$splitComponentImporter$z = () => import("./busca-produtos-YQ4L-uq9.js");
const Route$A = createFileRoute("/busca-produtos")({
  component: lazyRouteComponent($$splitComponentImporter$z, "component")
});
const $$splitComponentImporter$y = () => import("./ativacao-smiilASt.js");
const Route$z = createFileRoute("/ativacao")({
  component: lazyRouteComponent($$splitComponentImporter$y, "component")
});
const $$splitComponentImporter$x = () => import("./_app-BJgIpBt0.js");
const Route$y = createFileRoute("/_app")({
  component: lazyRouteComponent($$splitComponentImporter$x, "component")
});
const $$splitComponentImporter$w = () => import("./_slug-CJ4xVLQh.js");
const Route$x = createFileRoute("/$slug")({
  component: lazyRouteComponent($$splitComponentImporter$w, "component")
});
const $$splitComponentImporter$v = () => import("./index-lEu3uR6z.js");
const Route$w = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$v, "component")
});
const $$splitComponentImporter$u = () => import("./index-kjPDSeG8.js");
const Route$v = createFileRoute("/office/")({
  component: lazyRouteComponent($$splitComponentImporter$u, "component")
});
const $$splitComponentImporter$t = () => import("./seja-distribuidor._slug-D55M866l.js");
const Route$u = createFileRoute("/seja-distribuidor/$slug")({
  component: lazyRouteComponent($$splitComponentImporter$t, "component")
});
const $$splitComponentImporter$s = () => import("./produto._id-BBAsTUzN.js");
const Route$t = createFileRoute("/produto/$id")({
  component: lazyRouteComponent($$splitComponentImporter$s, "component")
});
const $$splitComponentImporter$r = () => import("./verification-DuyIsg4f.js");
const Route$s = createFileRoute("/office/verification")({
  component: lazyRouteComponent($$splitComponentImporter$r, "component")
});
const $$splitComponentImporter$q = () => import("./store-bxk2BmDx.js");
const Route$r = createFileRoute("/office/store")({
  component: lazyRouteComponent($$splitComponentImporter$q, "component")
});
const $$splitComponentImporter$p = () => import("./reports-4dAWQIEK.js");
const Route$q = createFileRoute("/office/reports")({
  component: lazyRouteComponent($$splitComponentImporter$p, "component")
});
const $$splitComponentImporter$o = () => import("./profile-CKtQXoXd.js");
const Route$p = createFileRoute("/office/profile")({
  component: lazyRouteComponent($$splitComponentImporter$o, "component")
});
const $$splitComponentImporter$n = () => import("./plan-HU9XG6qn.js");
const Route$o = createFileRoute("/office/plan")({
  component: lazyRouteComponent($$splitComponentImporter$n, "component")
});
const $$splitComponentImporter$m = () => import("./orders-AFMDSW1I.js");
const Route$n = createFileRoute("/office/orders")({
  component: lazyRouteComponent($$splitComponentImporter$m, "component")
});
const $$splitComponentImporter$l = () => import("./network-CDLdKFtl.js");
const Route$m = createFileRoute("/office/network")({
  component: lazyRouteComponent($$splitComponentImporter$l, "component")
});
const $$splitComponentImporter$k = () => import("./finance-CozZ4zVU.js");
const Route$l = createFileRoute("/office/finance")({
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("./downloads-CqgIhn4M.js");
const Route$k = createFileRoute("/office/downloads")({
  component: lazyRouteComponent($$splitComponentImporter$j, "component")
});
const $$splitComponentImporter$i = () => import("./copilot-DpefVZK3.js");
...
function PublicHeader() {
  ...
  return /* @__PURE__ */ jsx("header", { className: "fixed top-0 z-40 w-full border-b border-allin-orange/20 bg-allin-bg-light-1/95 shadow-sm backdrop-blur-md dark:border-allin-bg-dark-2 dark:bg-allin-bg-dark-1/95", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 py-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxs(Link, { to: "/", className: "flex items-center gap-2.5", children: [
        ...
        /* @__PURE__ */ jsx("span", { className: "text-xl font-bold text-allin-orange md:text-2xl", children: "All-In" })
      ] }),
      /* @__PURE__ */ jsx("nav", { className: "hidden items-center gap-6 md:flex", children: navItems.map((item) => /* @__PURE__ */ jsx(
        Link,
        {
          to: item.href,
      ...
      /* @__PURE__ */ jsxs("div", { className: "hidden items-center gap-3 md:flex", children: [
        ...
        user ? /* @__PURE__ */ jsx(Link, { to: dashboardHref, children: /* @__PURE__ */ jsx(Button, { variant: "outline", className: "border-allin-orange text-allin-orange hover:bg-allin-orange/10 font-semibold", children: "Dashboard" }) }) : /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx(Link, { to: "/login", children: /* @__PURE__ */ jsx(Button, { variant: "outline", className: "border-allin-orange text-allin-orange hover:bg-allin-orange/10 font-semibold", children: "Entrar" }) }),
          /* @__PURE__ */ jsx(
            Button,
            {
    ...
    /* @__PURE__ */ jsx(AnimatePresence, { children: isMobileMenuOpen && /* @__PURE__ */ jsx(
      motion.div,
      {
        ...
        className: "md:hidden",
        children: /* @__PURE__ */ jsxs("div", { className: "mt-4 space-y-3 border-t border-allin-orange/20 pt-4 dark:border-allin-bg-dark-2", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "pt-2", children: user ? /* @__PURE__ */ jsx(Link, { to: dashboardHref, children: /* @__PURE__ */ jsx(
            Button,
            {
              variant: "outline",
            ...
            /* @__PURE__ */ jsx(Link, { to: "/login", children: /* @__PURE__ */ jsx(
              Button,
              {
                variant: "outline",
                className: "w-full border-allin-orange text-allin-orange hover:bg-allin-orange/10 font-semibold",
...
function DistributorStorePage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#06080d] text-white selection:bg-emerald-500/30 overflow-x-hidden", children: [
    /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-r from-[#0d1627] to-[#070b13] border-b border-border/10 px-4 py-2.5 text-center flex flex-wrap items-center justify-center gap-2 text-xs relative z-40", children: [
      /* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full bg-emerald-500 animate-pulse shrink-0" }),
      /* @__PURE__ */ jsxs("p", { className: "text-zinc-300 font-sans", children: [
        "Você está navegando na loja virtual oficial de",
        /* @__PURE__ */ jsxs("strong", { className: "text-white hover:underline cursor-pointer", children: [
          " ",
          distName
        ] })
      ] }),
      /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "border-emerald-500/20 bg-emerald-500/5 text-emerald-400 text-[10px] font-mono leading-none py-0.5 uppercase", children: distRank }),
      /* @__PURE__ */ jsxs(
        Link,
        {
          to: "/$slug",
    ...
    /* @__PURE__ */ jsxs("main", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 md:py-12 space-y-12 relative", children: [
      /* @__PURE__ */ jsxs(AnimatePresence, { mode: "wait", children: [
        checkoutStep === "catalog" && /* @__PURE__ */ jsxs(
          motion.div,
          {
            initial: { opacity: 0 },
            animate: { opacity: 1 },
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-3xl border border-zinc-800 bg-gradient-to-br from-indigo-950/20 via-zinc-900/40 to-transparent p-6 sm:p-10", children: [
                /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 h-96 w-96 bg-gradient-to-b from-purple-500/10 to-transparent blur-3xl pointer-events-none rounded-full" }),
                /* @__PURE__ */ jsxs("div", { className: "relative max-w-2xl space-y-4", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold tracking-widest font-mono text-emerald-400 border border-emerald-500/25 px-2.5 py-1 rounded-full uppercase", children: "PRODUTOS HOMOLOGADOS COM PATENTE" }),
                  /* @__PURE__ */ jsx("h1", { className: "text-3xl sm:text-4xl font-black tracking-tight leading-snug", children: "Ciência Bioativa Aplicada à Longevidade Saudável" }),
                  /* @__PURE__ */ jsxs("p", { className: "text-sm text-zinc-400 leading-relaxed", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
                /* @__PURE__ */ jsxs("h2", { className: "text-xl font-bold tracking-tight text-white flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx(ShoppingBag, { className: "h-4 w-4 text-emerald-400" }),
                  " Vitrina de Compras"
                ] }),
                /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: products.map((prod) => /* @__PURE__ */ jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                        ...
                        /* @__PURE__ */ jsx("div", { className: "absolute top-2 right-2 flex flex-col gap-1 items-end", children: /* @__PURE__ */ jsx("span", { className: "text-[8px] font-bold font-mono text-emerald-400 bg-background/90 px-2 py-0.5 rounded-md border border-emerald-500/25 uppercase", children: prod.categorias }) })
                      ] }),
                      /* @__PURE__ */ jsxs("div", { className: "p-4 space-y-4 flex-1 flex flex-col justify-between", children: [
                        ...
                        /* @__PURE__ */ jsxs("div", { className: "space-y-3 pt-3 border-t border-border/20", children: [
              ...
              /* @__PURE__ */ jsxs("div", { id: "cart-drawer", className: "rounded-3xl border border-zinc-800 bg-[#090d16]/85 p-6 md:p-8 grid md:grid-cols-12 gap-8 scroll-mt-24", children: [
                /* @__PURE__ */ jsxs("div", { className: "md:col-span-7 space-y-4", children: [
                  /* @__PURE__ */ jsxs("h3", { className: "text-md font-bold text-white flex items-center gap-2", children: [
                    /* @__PURE__ */ jsx(ShoppingBag, { className: "h-4.5 w-4.5 text-emerald-400" }),
                    " Seu Carrinho de Compras"
                  ] }),
                  cart.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-12 space-y-3 border border-dashed border-border/40 rounded-2xl bg-background/20", children: [
                    /* @__PURE__ */ jsx("p", { className: "text-sm text-zinc-500", children: "Seu carrinho está vazio." }),
                    /* @__PURE__ */ jsx(
                      "button",
                      {
                  ...
                  ] }) : /* @__PURE__ */ jsx("div", { className: "space-y-3.5 divide-y divide-border/25", children: cart.map((item) => /* @__PURE__ */ jsxs("div", { className: "flex gap-4 items-center pt-3.5 first:pt-0", children: [
                    /* @__PURE__ */ jsx(
                      "img",
                      {
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                      /* @__PURE__ */ jsx("h4", { className: "text-xs font-bold text-white truncate", children: item.product.name }),
                      /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-emerald-400 font-mono", children: [
                        "+",
                        item.product.bonus_payment_percentage || 20,
                        " Pontos MLM por unidade"
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 bg-[#06080d] border border-border/80 rounded-lg p-0.5", children: [
                      /* @__PURE__ */ jsx("button", { onClick: () => updateQty(item.product.id, -1), className: "h-6 w-6 rounded-md hover:bg-background/80 flex items-center justify-center shrink-0 text-zinc-400 hover:text-white cursor-pointer", children: /* @__PURE__ */ jsx(Minus, { className: "h-3 w-3" }) }),
                      /* @__PURE__ */ jsx("span", { className: "text-xs font-bold font-mono px-2 w-6 text-center", children: item.quantity }),
                      /* @__PURE__ */ jsx("button", { onClick: () => updateQty(item.product.id, 1), className: "h-6 w-6 rounded-md hover:bg-background/80 flex items-center justify-center shrink-0 text-zinc-400 hover:text-white cursor-pointer", children: /* @__PURE__ */ jsx(Plus, { className: "h-3 w-3" }) })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "text-right pl-2", children: [
                      /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-white", children: formatBRL(item.product.price * item.quantity) }),
                      /* @__PURE__ */ jsxs("button", { onClick: () => removeFromCart(item.product.id), className: "text-[10px] text-rose-400 hover:underline inline-flex items-center gap-0.5 mt-0.5 cursor-pointer", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "md:col-span-1 border-r border-border/10 hidden md:block" }),
                /* @__PURE__ */ jsxs("div", { className: "md:col-span-4 space-y-4", children: [
                  /* @__PURE__ */ jsx("div", { className: "p-3 bg-background/50 rounded-xl border border-border/30 text-center", children: /* @__PURE__ */ jsx("p", { className: "text-[10px] uppercase font-bold text-muted-foreground tracking-wider font-mono", children: "Resumo Financeiro" }) }),
                  /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                    /* @__PURE__ */ jsx("label", { className: "text-[10px] uppercase font-bold text-muted-foreground tracking-widest block font-mono", children: "Cupom Cadastrado" }),
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "p-4 rounded-xl bg-background/50 border border-border/30 space-y-2 text-xs font-mono", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-zinc-400", children: [
                      /* @__PURE__ */ jsx("span", { children: "Subtotal:" }),
                      /* @__PURE__ */ jsx("span", { className: "text-white", children: formatBRL(subtotal) })
                    ] }),
                    discount > 0 && /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-rose-400", children: [
                      /* @__PURE__ */ jsx("span", { children: "Desconto ALLIN10 (-10%):" }),
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-zinc-400", children: [
                      /* @__PURE__ */ jsx("span", { children: "Frete Internacional (Sedex):" }),
                      /* @__PURE__ */ jsx("span", { className: "text-white", children: deliveryCost === 0 ? "Grátis" : formatBRL(deliveryCost) })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "border-t border-zinc-800 pt-3 flex justify-between font-bold text-sm", children: [
                      /* @__PURE__ */ jsx("span", { className: "text-white font-sans font-bold", children: "Total Geral:" }),
                      /* @__PURE__ */ jsx("span", { className: "text-emerald-400 font-extrabold", children: formatBRL(finalTotal) })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxs(
                    "button",
        ...
        checkoutStep === "checkout" && /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center border-b border-border/20 pb-4", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-white leading-tight", children: "Checkout do Consumidor Final" }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-zinc-400 mt-1", children: "Inscreva seus dados para calcular entrega e processar cashback de rede All-In." })
                ] }),
                /* @__PURE__ */ jsxs(
                  "button",
                  {
              ...
              /* @__PURE__ */ jsxs("form", { onSubmit: handlePurchaseSubmit, className: "grid md:grid-cols-12 gap-8", children: [
                /* @__PURE__ */ jsxs("div", { className: "md:col-span-7 space-y-4", children: [
                  /* @__PURE__ */ jsx("h3", { className: "text-xs font-bold font-mono uppercase tracking-widest text-[#a855f7] bg-purple-500/15 border border-purple-500/20 px-2 rounded-md py-0.5 inline-block", children: "1. Dados Governamentais & Cobrança" }),
                  /* @__PURE__ */ jsxs("div", { className: "space-y-3.5", children: [
                    /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                      /* @__PURE__ */ jsx("label", { className: "text-[10px] uppercase font-bold text-muted-foreground font-mono", children: "Nome Completo do Destinatário" }),
                      /* @__PURE__ */ jsx(
                        "input",
                        {
                          type: "text",
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-3", children: [
                      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                        /* @__PURE__ */ jsx("label", { className: "text-[10px] uppercase font-bold text-muted-foreground font-mono", children: "E-mail para Nota Fiscal" }),
                        /* @__PURE__ */ jsx(
                          "input",
                          {
                            type: "email",
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                        /* @__PURE__ */ jsx("label", { className: "text-[10px] uppercase font-bold text-muted-foreground font-mono", children: "CPF para Registros Fiscais" }),
                        /* @__PURE__ */ jsx(
                          "input",
                          {
                            type: "text",
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-3", children: [
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                        /* @__PURE__ */ jsx("label", { className: "text-[10px] uppercase font-bold text-muted-foreground font-mono", children: "Modalidade de Frete" }),
                        /* @__PURE__ */ jsxs(
                          "select",
                          {
                            value: deliveryType,
                            ...
                            children: [
                              /* @__PURE__ */ jsx("option", { value: "sedex", children: "Sedex Expresso Internacional (3 dias úteis)" }),
                              /* @__PURE__ */ jsx("option", { value: "pac", children: "PAC Standart (8 dias úteis)" })
                            ]
                          }
                        )
                      ] })
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "space-y-3 pt-4 border-t border-border/15", children: [
                    /* @__PURE__ */ jsx("h3", { className: "text-xs font-bold font-mono uppercase tracking-widest text-[#a855f7] bg-purple-500/15 border border-purple-500/20 px-2 rounded-md py-0.5 inline-block", children: "2. Escolha o Método de Liquidação" }),
                    ...
                    /* @__PURE__ */ jsx(AnimatePresence, { mode: "wait", children: payMethod === "card" && /* @__PURE__ */ jsxs(
                      motion.div,
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                            /* @__PURE__ */ jsx("label", { className: "text-[9px] uppercase font-bold text-muted-foreground font-mono", children: "Número do Cartão de Crédito" }),
                            /* @__PURE__ */ jsx(
                              "input",
                              {
                                type: "text",
                          ...
                          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
                            /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                              /* @__PURE__ */ jsx("label", { className: "text-[9px] uppercase font-bold text-muted-foreground font-mono font-mono", children: "Expiração (MM/AA)" }),
                              /* @__PURE__ */ jsx(
                                "input",
                                {
                                  type: "text",
                            ...
                            /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                              /* @__PURE__ */ jsx("label", { className: "text-[9px] uppercase font-bold text-muted-foreground font-mono font-mono", children: "CVC de Segurança" }),
                              /* @__PURE__ */ jsx(
                                "input",
                                {
                                  type: "text",
                ...
                /* @__PURE__ */ jsxs("div", { className: "md:col-span-5 space-y-5", children: [
                  /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-zinc-800 bg-[#06080d] p-5 space-y-4", children: [
                    /* @__PURE__ */ jsx("h4", { className: "text-xs font-bold uppercase tracking-widest text-[#a855f7] bg-purple-500/15 border border-purple-500/20 px-2 rounded-md py-0.5 inline-block", children: "3. Resumo dos Itens" }),
                    /* @__PURE__ */ jsx("div", { className: "space-y-3/5 max-h-48 overflow-y-auto divide-y divide-border/15 pr-1", children: cart.map((item) => /* @__PURE__ */ jsxs("div", { className: "flex gap-2.5 items-center pt-2.5 first:pt-0 text-xs", children: [
                      /* @__PURE__ */ jsxs("span", { className: "font-bold text-emerald-400 font-mono text-[11px] shrink-0", children: [
                        "x",
                        item.quantity
                      ] }),
                      /* @__PURE__ */ jsx("span", { className: "text-white font-medium truncate flex-1", children: item.product.caption }),
                      /* @__PURE__ */ jsx("span", { className: "font-mono text-zinc-400 shrink-0", children: formatBRL(item.product.price) })
                    ] }, item.product.id)) }),
                    /* @__PURE__ */ jsxs("div", { className: "p-3 bg-emerald-500/5 rounded-xl border border-emerald-500/20 text-xs text-zinc-300 space-y-1.5 leading-relaxed font-sans", children: [
                      /* @__PURE__ */ jsx("p", { className: "font-bold text-emerald-400 uppercase tracking-widest text-[9px] font-mono select-none", children: "Bônus & Patrocínio Direto" }),
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 pt-1 border-t border-emerald-500/10 mt-1", children: [
                        /* @__PURE__ */ jsx("img", { src: distAvatar, alt: distName, className: "h-6 w-6 rounded-full border border-emerald-500/30 object-cover" }),
                        /* @__PURE__ */ jsxs("div", { children: [
                          /* @__PURE__ */ jsx("p", { className: "font-semibold text-white text-[11px]", children: distName }),
                          /* @__PURE__ */ jsxs("p", { className: "text-[9px] text-emerald-400 font-mono leading-none", children: [
                            "@",
                            sponsorSlug
                          ] })
                        ] })
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 border-t border-zinc-800 pt-3 text-xs font-mono", children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-zinc-500", children: [
                        /* @__PURE__ */ jsx("span", { children: "Produtos:" }),
                        /* @__PURE__ */ jsx("span", { className: "text-white", children: formatBRL(subtotal) })
                      ] }),
                      discount > 0 && /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-rose-400", children: [
                        /* @__PURE__ */ jsx("span", { children: "Desconto Promo:" }),
                        /* @__PURE__ */ jsxs("span", { children: [
                          "-",
                          formatBRL(discount)
                        ] })
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-zinc-500", children: [
                        /* @__PURE__ */ jsx("span", { children: "Inoculação Sedex:" }),
                        /* @__PURE__ */ jsx("span", { className: "text-white", children: deliveryCost === 0 ? "Grátis" : formatBRL(deliveryCost) })
                      ] }),
                      /* @__PURE__ */ jsxs("div", { className: "border-t border-zinc-900 pt-2 flex justify-between font-bold text-sm", children: [
                        /* @__PURE__ */ jsx("span", { className: "text-white font-sans font-bold", children: "Total Final:" }),
                        /* @__PURE__ */ jsx("span", { className: "text-emerald-400 font-extrabold", children: formatBRL(finalTotal) })
                      ] })
                    ] })
                  ] }),
        ...
        checkoutStep === "processing" && /* @__PURE__ */ jsxs(
          motion.div,
          {
            initial: { opacity: 0 },
            animate: { opacity: 1 },
            ...
            children: [
              /* @__PURE__ */ jsx("div", { className: "h-12 w-12 rounded-full border-2 border-t-emerald-400 border-r-transparent border-b-transparent border-l-transparent animate-spin mx-auto" }),
              /* @__PURE__ */ jsx("h3", { className: "text-sm font-bold text-white", children: "Segurando Gateway de Pagamento All-In..." }),
              /* @__PURE__ */ jsxs("p", { className: "text-xs text-muted-foreground max-w-xs mx-auto leading-relaxed", children: [
        ...
        checkoutStep === "receipt" && /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 text-center", children: [
                /* @__PURE__ */ jsx("h3", { className: "text-md font-bold text-white", children: "Transação Faturada com Sucesso!" }),
                /* @__PURE__ */ jsxs("p", { className: "text-xs text-muted-foreground leading-relaxed max-w-sm mx-auto", children: [
                  "Olá, ",
                  /* @__PURE__ */ jsx("strong", { className: "text-white", children: custName }),
                  "! Seu pedido foi faturado. Um e-mail de conformidade fiscal e código de rastreio Sedex foi encaminhado para ",
                  /* @__PURE__ */ jsx("strong", { className: "text-white", children: custEmail }),
                  "."
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "p-4 border border-border/45 rounded-xl bg-background/50 text-[10px] text-muted-foreground font-mono space-y-1.5 text-center select-all", children: [
                /* @__PURE__ */ jsx("p", { className: "font-sans text-[9px] uppercase tracking-wider text-muted-foreground mb-1", children: "Assinatura Digital de Ledger Criptográfico" }),
      ...
      /* @__PURE__ */ jsx(AnimatePresence, { children: selectedProductDetails && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-black/85 backdrop-blur-sm z-50 flex items-center justify-center p-4", children: /* @__PURE__ */ jsxs(
        motion.div,
        {
          initial: { opacity: 0, scale: 0.95 },
          animate: { opacity: 1, scale: 1 },
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("span", { className: "text-[10px] bg-emerald-500/15 text-emerald-400 font-mono font-bold px-2 py-0.5 rounded-md border border-emerald-500/20", children: selectedProductDetails.category }),
                /* @__PURE__ */ jsx("h3", { className: "text-md font-bold text-white mt-1.5", children: selectedProductDetails.name })
              ] }),
              /* @__PURE__ */ jsx(
                "button",
                {
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2 text-xs text-zinc-300 leading-relaxed", children: [
              /* @__PURE__ */ jsx("p", { children: selectedProductDetails.description }),
              /* @__PURE__ */ jsxs("div", { className: "p-3 bg-background border border-border/40 rounded-xl grid grid-cols-2 gap-2 text-center text-xs", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("p", { className: "text-[10px] text-muted-foreground font-mono", children: "Fabricante" }),
                  /* @__PURE__ */ jsx("p", { className: "font-semibold text-white", children: selectedProductDetails.manufacturer })
                ] }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("p", { className: "text-[10px] text-muted-foreground font-mono", children: "Pontos MLM" }),
                  /* @__PURE__ */ jsxs("p", { className: "font-semibold text-emerald-400 font-mono", children: [
                    "+",
            ...
            /* @__PURE__ */ jsxs("div", { className: "pt-2 flex justify-between items-center border-t border-zinc-800", children: [
              /* @__PURE__ */ jsx("strong", { className: "text-md text-white font-bold", children: formatBRL(selectedProductDetails.price) }),
              /* @__PURE__ */ jsx(
                "button",
                {
                  onClick: () => {
    ...
    /* @__PURE__ */ jsx("footer", { className: "border-t border-zinc-900 bg-[#040609] py-12 relative z-10 text-xs text-zinc-500", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center space-y-3", children: [
      /* @__PURE__ */ jsxs("p", { className: "font-semibold text-white uppercase tracking-widest text-[11px]", children: [
        "All-In Life · Loja Autorizada de ",
        distName
      ] }),
      /* @__PURE__ */ jsx("p", { className: "max-w-md mx-auto leading-relaxed", children: "Plataforma de varejo integrada à estrutura da All-In Brasil. Suas transações faturam cashback direto e volume de perna de rede em conformidade com as diretivas MLM oficiais." }),
      /* @__PURE__ */ jsxs("p", { className: "text-[10px]", children: [
        ...
        " · ID: ",
        /* @__PURE__ */ jsx("span", { className: "text-zinc-400 font-mono", children: matchedUser?.id || "dist_001" })
      ] })
    ] }) })
  ] });
}
const $$splitComponentImporter$h = () => import("./doencas._slug-Bkfv8gur.js");
const Route$h = createFileRoute("/doencas/$slug")({
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("./busca-produtos._slug-B7najhgK.js");
const Route$g = createFileRoute("/busca-produtos/$slug")({
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("./wallets-BnlhHms0.js");
const Route$f = createFileRoute("/_app/wallets")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./system-BTA3BmO4.js");
const Route$e = createFileRoute("/_app/system")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./settings-Dk8IF1rx.js");
const Route$d = createFileRoute("/_app/settings")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./plans-BftIExwX.js");
const Route$c = createFileRoute("/_app/plans")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./network-DZi-xX4b.js");
const Route$b = createFileRoute("/_app/network")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./marketing-Dt_gVTxB.js");
const Route$a = createFileRoute("/_app/marketing")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./insights-sMXT8eOQ.js");
const Route$9 = createFileRoute("/_app/insights")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./copilot-BlWj1tdt.js");
const Route$8 = createFileRoute("/_app/copilot")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./commissions-UusOHt_h.js");
const Route$7 = createFileRoute("/_app/commissions")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./analytics-DWQhskaL.js");
const Route$6 = createFileRoute("/_app/analytics")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./alerts-Bbc_1hUv.js");
const Route$5 = createFileRoute("/_app/alerts")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./index-BGxCSFug.js");
const Route$4 = createFileRoute("/_app/products/")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./index-I6s2P8Ym.js");
const Route$3 = createFileRoute("/_app/orders/")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./index--tXzc70L.js");
const Route$2 = createFileRoute("/_app/customers/")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./auth.invite._token-DDLZjs-7.js");
const Route$1 = createFileRoute("/auth/invite/$token")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./_id-BMwraojf.js");
const Route = createFileRoute("/_app/customers/$id")({
  ...
  loader: async ({
    ...
    const {
      data
    } = await supabase.from("customers").select("id, usuario, id_comprador, user_id, qualification, status, cidade, estado, telefone, metadata, plano_id, plan_id, patrocinador_comprador, created_at").eq("id", params.id).maybeSingle();
