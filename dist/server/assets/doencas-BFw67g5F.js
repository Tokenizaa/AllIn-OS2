...
import { d as useDistributor, P as PublicHeader, B as Button } from "./router-C3cuB5ui.js";
import { F as Footer } from "./Footer-BcDSIlay.js";
import { D as DiseaseCard } from "./DiseaseCard-BPrkhxqS.js";
...
function DiseasesPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-allin-bg-light-1 dark:bg-allin-bg-dark-1", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "pt-20", children: /* @__PURE__ */ jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-16 text-center", children: /* @__PURE__ */ jsx(Link, { to: isDefaultTenant ? "/loja" : `/loja/${sponsorSlug}`, children: /* @__PURE__ */ jsx(Button, { variant: "vibrant", size: "lg", className: "text-lg px-8 py-6", children: "Ver Produtos que Podem Ajudar" }) }) })
    ] }) }) }),
    /* @__PURE__ */ jsx(Footer, {})
  ] });
}
