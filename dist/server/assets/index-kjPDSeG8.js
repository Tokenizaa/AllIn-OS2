...
import { S as StatCard } from "./stat-card-MI_8FSUR.js";
...
function OfficeDashboardCharts({
  salesSeries,
  bonusOrigin
}) {
  return /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-3 gap-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "xl:col-span-2 rounded-2xl border border-border/60 bg-card/60 p-5", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "h-72 mt-4", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(AreaChart, { data: salesSeries, children: [
        ...
        /* @__PURE__ */ jsx(YAxis, { stroke: "var(--color-muted-foreground)", fontSize: 11, tickFormatter: (v) => `${(Number(v) / 1e3).toFixed(1)}k` }),
        /* @__PURE__ */ jsx(Tooltip, { contentStyle: ttStyle }),
        /* @__PURE__ */ jsx(Area, { type: "monotone", dataKey: "vendas", stroke: "var(--color-primary)", fill: "var(--color-primary)", fillOpacity: 0.2, strokeWidth: 2 }),
        /* @__PURE__ */ jsx(Area, { type: "monotone", dataKey: "bonus", stroke: "var(--color-success)", fill: "var(--color-success)", fillOpacity: 0.12, strokeWidth: 2 })
      ] }) }) })
    ] }),
...
function TopProductsChart({ data }) {
  return /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(BarChart, { data, layout: "vertical", margin: { left: 0, right: 12 }, children: [
...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    void (async () => {
      const [ordersRes, paymentsRes, customersRes, productsRes, withdrawalsRes, profileRes] = await Promise.all([supabase.from("orders").select("id, numero_pedido, valor_total_pedido, valor_total, created_at, status, status_pedido").order("created_at", {
        ...
        ascending: false
      }).limit(300), supabase.from("customers").select("id, usuario, id_comprador, user_id, status, created_at").limit(300), supabase.from("products").select("id, name, price").limit(20), supabase.from("withdrawals").select("id, amount, created_at, status").order("created_at", {
        ascending: false
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsx(OfficeDashboardCharts, { salesSeries, bonusOrigin, topProducts }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-3 gap-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-border/60 bg-card/60 p-5", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "h-44 mt-3", children: /* @__PURE__ */ jsx(TopProductsChart, { data: topProducts }) })
      ] })
    ] })
  ] });
}
