...
import { c as cn, B as Button } from "./router-Piw3VGP8.js";
...
import { g as getOrders } from "./orders.api--0MD7_vi.js";
...
const getCustomers = createServerFn({
  method: "GET"
}).inputValidator(paginationSchema.merge(filterSchema)).handler(createSsrRpc("02ed2db877d1329c3f89f2d0123785a24e1de4a932eef4ba90471d8774175029"));
createServerFn({
  method: "GET"
...
createServerFn({
  method: "POST"
}).inputValidator(createCustomerSchema).handler(createSsrRpc("9ce74d56ab10e90f28f2e429e94c51bf32876c96e72f9fb625dbf596d2132039"));
createServerFn({
  method: "POST"
}).inputValidator(z.object({
  id: z.string().uuid(),
