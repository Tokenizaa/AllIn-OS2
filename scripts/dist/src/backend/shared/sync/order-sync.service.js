...
export class OrderSyncService extends BaseSyncService {
    ...
    async sync(params) {
        ...
        try {
            ...
            const allinOrders = await this.executeWithRetry(() => allinService.getPedidos(), 'Fetch orders from AllIn');
            ...
            await this.processAllBatches(localOrders, async (order) => await this.processOrder(order, params), result);
     ...
     */
    async processOrder(order, params) {
        try {
