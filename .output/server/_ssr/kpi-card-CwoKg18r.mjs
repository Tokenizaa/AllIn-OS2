...
function KpiCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card/60 p-4 hover:bg-card transition-colors", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      ...
      delta !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: cn("inline-flex items-center gap-0.5 text-xs font-medium", up ? "text-success" : "text-destructive"), children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex items-end justify-between gap-2", children: [
      ...
      spark && spark.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkline, { values: spark, accent })
    ] }),
    hint && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1.5 text-[11px] text-muted-foreground", children: hint })
  ] });
}
function Sparkline({ values, accent }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: w, height: h, className: "opacity-90", children: /* @__PURE__ */ jsxRuntimeExports.jsx("polyline", { points: pts, fill: "none", stroke, strokeWidth: "1.5" }) });
}
export {
  KpiCard as K
};
