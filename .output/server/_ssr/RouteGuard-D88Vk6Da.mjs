...
import { g as useNavigate, e as useLocation } from "../_libs/tanstack__react-router.mjs";
import { b as useAuth, j as getPrimaryPathForRole, f as getRoleRedirectPath } from "./router-BZaVudxP.mjs";
...
const RouteGuard = ({ children, allowedRoles, requiredPermission }) => {
  ...
  if (loading) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col items-center justify-center bg-[#07090e] text-white", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-10 w-10 animate-spin rounded-full border-2 border-t-primary border-r-transparent border-b-transparent border-l-transparent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute h-6 w-6 animate-ping rounded-full bg-primary/20" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-xs font-mono text-muted-foreground uppercase tracking-wider", children: "Iniciando ambiente de segurança..." })
    ] });
  }
  if (!user) return null;
