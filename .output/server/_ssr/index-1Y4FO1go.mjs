...
import { C as CartSidebar, P as ProductGallery } from "./CartSidebar-DkYld7sC.mjs";
...
import { d as useDistributor, b as useAuth, j as getPrimaryPathForRole, P as PublicHeader } from "./router-BZaVudxP.mjs";
import "../_libs/sonner.mjs";
import { Z as Zap, af as Waves, ag as Wind, n as Star } from "../_libs/lucide-react.mjs";
...
const ModelsSection = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-allin-bg-light-2 dark:bg-allin-bg-dark-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductGallery, { limit: 4 }) }) });
};
const ProductsSection = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "produtos", className: "py-20 bg-allin-bg-light-2 dark:bg-allin-bg-dark-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 animate-fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-5xl font-bold mb-6 text-allin-dark dark:text-allin-white", children: [
        "Produtos e ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-allin-orange", children: "Tecnologias" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-allin-dark/80 dark:text-allin-white/80 max-w-3xl mx-auto", children: "Tecnologias exclusivas que transformam cada passo em bem-estar." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-3xl font-bold text-center mb-12 text-allin-dark dark:text-allin-white animate-slide-up", children: [
        "Tecnologias ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-allin-orange", children: "Exclusivas" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-8", children: technologies.map((tech, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "relative overflow-hidden border border-allin-orange/40 shadow-xl hover:shadow-2xl transition-all duration-300 group bg-allin-bg-light-1 dark:bg-allin-bg-dark-3 animate-slide-up glass-card", style: { animationDelay: `${0.1 * index}s` }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-allin-orange opacity-5 group-hover:opacity-10 transition-opacity" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "text-center pb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 bg-allin-orange rounded-full flex items-center justify-center mx-auto mb-4 animate-pulse-glow transition-transform duration-300 group-hover:scale-110", children: /* @__PURE__ */ jsxRuntimeExports.jsx(tech.icon, { className: "w-10 h-10 text-allin-dark" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-2xl font-bold text-allin-dark dark:text-allin-white", children: tech.name })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: tech.benefits.map((benefit, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 transition-all duration-300 hover:translate-x-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-5 h-5 text-allin-orange mt-0.5 flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-allin-dark/80 dark:text-allin-white/80", children: benefit })
        ] }, idx)) }) })
      ] }, index)) })
    ] })
  ] }) });
...
const DiseaseIdentificationSection = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "problemas", className: "py-20 bg-allin-bg-light-1 dark:bg-allin-bg-dark-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 animate-fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-5xl font-bold mb-6 text-allin-dark dark:text-allin-white", children: [
        "Identifique seu ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-allin-orange", children: "problema" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-allin-dark/80 dark:text-allin-white/80 max-w-3xl mx-auto", children: "Conheça os sintomas mais comuns e como nossos produtos podem aliviar seu desconforto diário" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-8", children: conditions.map((condition, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border border-allin-orange/40 shadow-lg hover:shadow-xl transition-all duration-300 bg-allin-bg-light-2 dark:bg-allin-bg-dark-2 group animate-slide-up glass-card", style: { animationDelay: `${0.1 * index}s` }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded-t-lg h-40", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: condition.image,
          alt: condition.title,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "text-center pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-xl font-bold text-allin-dark dark:text-allin-white", children: condition.title }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-allin-dark/80 dark:text-allin-white/80 text-center leading-relaxed mb-3", children: condition.description }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-allin-orange/20 pt-3 mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-allin-orange font-medium text-center", children: [
          "Benefício: ",
          condition.benefit
        ] }) })
      ] })
...
const FAQAccordionSection = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "faq", className: "py-20 bg-allin-bg-light-3 dark:bg-allin-bg-dark-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 animate-fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-5xl font-bold mb-6 text-allin-dark dark:text-allin-white", children: [
        "Dúvidas ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-allin-orange", children: "Frequentes" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xl text-allin-dark/80 dark:text-allin-white/80 max-w-3xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "melhor decisão" }),
        " e começar sua jornada de sucesso com a Allin hoje mesmo."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-8", children: faqData.map((category, catIndex) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold text-allin-orange mb-6 text-center", children: category.category }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Accordion, { type: "single", collapsible: true, className: "space-y-4", children: category.items.map((faq, faqIndex) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        AccordionItem,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "text-left font-semibold text-lg px-6 hover:no-underline text-allin-dark dark:text-allin-white hover:text-allin-orange transition-colors", children: faq.question }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "px-6 pb-6 text-allin-dark/80 dark:text-allin-white/80 leading-relaxed", children: faq.answer })
          ]
        },
        faqIndex
      )) })
...
const HomeTestimonialsSection = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-allin-bg-light-2 dark:bg-allin-bg-dark-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl font-bold mb-4 text-allin-dark dark:text-allin-white", children: [
        "Histórias reais de quem recuperou a liberdade de",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-allin-orange", children: "caminhar" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-allin-dark/70 dark:text-allin-white/70 max-w-2xl mx-auto", children: "Transformamos vidas todos os dias. Veja como os tênis Allin mudaram a realidade de pessoas reais." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: testimonials.map((testimonial, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "p-0 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-4xl text-allin-orange", children: '"' }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-allin-dark dark:text-allin-white mb-6 italic", children: [
              '"',
              testimonial.text,
              '"'
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-semibold text-allin-orange", children: [
              "— ",
              testimonial.author
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-allin-dark/70 dark:text-allin-white/70 mt-2", children: testimonial.condition })
          ] })
        ] })
      },
      index
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mt-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-allin-orange/10 rounded-2xl p-8 max-w-3xl mx-auto border border-allin-orange/20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold mb-4 text-allin-dark dark:text-allin-white", children: "Sua história pode ser a próxima!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-allin-dark/70 dark:text-allin-white/70 mb-6", children: "Milhares de pessoas já recuperaram sua mobilidade e qualidade de vida com a tecnologia Allin." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "bg-allin-orange text-allin-dark px-6 py-3 rounded-full font-semibold hover:bg-allin-orange/90 transition-colors", children: "Descubra seu Allin" })
    ] }) })
  ] }) });
};
function HomePage() {
