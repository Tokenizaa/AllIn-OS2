...
var _excluded$k = ["children"], _excluded2$8 = ["children"];
...
var isSingleChildEqual = function isSingleChildEqual2(nextChild, prevChild) {
  ...
  if (!isNil(nextChild) && !isNil(prevChild)) {
    ...
    var _ref2 = prevChild.props || {}, prevChildren = _ref2.children, prevProps = _objectWithoutProperties$k(_ref2, _excluded2$8);
    if (nextChildren && prevChildren) {
...
var _excluded$f = ["x", "y", "lineHeight", "capHeight", "scaleToFit", "textAnchor", "verticalAnchor", "fill"], _excluded2$7 = ["dx", "dy", "angle", "className", "breakAll"];
function _extends$r() {
...
var Text = function Text2(_ref5) {
  ...
  var dx = props.dx, dy = props.dy, angle = props.angle, className = props.className, breakAll = props.breakAll, textProps = _objectWithoutProperties$f(props, _excluded2$7);
...
var getAttrsOfCartesianLabel = function getAttrsOfCartesianLabel2(props) {
  ...
  if (isObject(position3) && (isNumber(position3.x) || isPercent(position3.x)) && (isNumber(position3.y) || isPercent(position3.y))) {
    return _objectSpread$q({
...
var _excluded$c = ["valueAccessor"], _excluded2$6 = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
...
function LabelList(_ref) {
  ...
  var data = restProps.data, dataKey = restProps.dataKey, clockWise = restProps.clockWise, id = restProps.id, textBreakAll = restProps.textBreakAll, others = _objectWithoutProperties$c(restProps, _excluded2$6);
  if (!data || !data.length) {
    return null;
  }
  return /* @__PURE__ */ React.createElement(Layer, {
...
var generatePrefixStyle = function generatePrefixStyle2(name, value) {
  ...
  var result = PREFIX_LIST.reduce(function(res, entry) {
    return _objectSpread$f(_objectSpread$f({}, res), {}, _defineProperty$i({}, entry + camelName, value));
  }, {});
  result[name] = value;
  return result;
};
...
var formatAxisMap2 = function formatAxisMap3(props, axisMap, offset, axisType, chartName) {
  ...
  return ids.reduce(function(result, id) {
    ...
    return _objectSpread$b(_objectSpread$b({}, result), {}, _defineProperty$e({}, id, finalAxis));
  }, {});
};
...
var createLabeledScales = function createLabeledScales2(options) {
  var scales = Object.keys(options).reduce(function(res, key) {
    return _objectSpread$b(_objectSpread$b({}, res), {}, _defineProperty$e({}, key, ScaleHelper.create(options[key])));
  }, {});
...
var Area = /* @__PURE__ */ (function(_PureComponent) {
  function Area2() {
    ...
    _this = _callSuper$4(this, Area2, [].concat(args));
  ...
  return _createClass$5(Area2, [{
    ...
    value: function renderAreaStatically(points, baseLine, needClip, clipPathId) {
      ...
      return /* @__PURE__ */ React.createElement(Layer, {
        clipPath: needClip ? "url(#clipPath-".concat(clipPathId, ")") : null
      }, /* @__PURE__ */ React.createElement(Curve, _extends$4({}, filterProps(others, true), {
        points,
        connectNulls,
        type,
        baseLine,
      ...
      })), stroke !== "none" && /* @__PURE__ */ React.createElement(Curve, _extends$4({}, filterProps(this.props, false), {
        ...
        fill: "none",
        points
      })), stroke !== "none" && isRange && /* @__PURE__ */ React.createElement(Curve, _extends$4({}, filterProps(this.props, false), {
        className: "recharts-area-curve",
        layout,
        type,
        connectNulls,
...
function XAxisImpl(_ref) {
  ...
  return (
    ...
    /* @__PURE__ */ reactExports.createElement(CartesianAxis, _extends$3({}, axisOptions, {
...
var XAxis = /* @__PURE__ */ (function(_React$Component) {
  function XAxis2() {
    ...
    return _callSuper$3(this, XAxis2, arguments);
  }
...
var YAxis = /* @__PURE__ */ (function(_React$Component) {
  function YAxis2() {
    ...
    return _callSuper$2(this, YAxis2, arguments);
  }
...
var _excluded$1 = ["item"], _excluded2 = ["children", "className", "width", "height", "style", "compact", "title", "desc"];
...
var generateCategoricalChart = function generateCategoricalChart2(_ref6) {
  ...
  var CategoricalChartWrapper = /* @__PURE__ */ (function(_Component) {
    function CategoricalChartWrapper2(_props) {
      ...
      _defineProperty$1(_this, "eventEmitterSymbol", /* @__PURE__ */ Symbol("rechartsEventEmitter"));
      ...
      _defineProperty$1(_this, "renderPolarAxis", function(element, displayName, index) {
        ...
        return /* @__PURE__ */ reactExports.cloneElement(element, _objectSpread$1(_objectSpread$1({}, axisOption), {}, {
      ...
      _defineProperty$1(_this, "renderLegend", function() {
        ...
        return /* @__PURE__ */ reactExports.cloneElement(item, _objectSpread$1(_objectSpread$1({}, otherProps), {}, {
          chartWidth: width,
          chartHeight: height,
          margin,
      ...
      _defineProperty$1(_this, "renderGraphicChild", function(element, displayName, index) {
        ...
        var graphicalItem = /* @__PURE__ */ reactExports.cloneElement(element, _objectSpread$1(_objectSpread$1({}, item.props), itemEvents));
        ...
        if (hasActive) {
          if (activeTooltipIndex >= 0) {
            ...
            if (activeShape || activeBar) {
              ...
              return [/* @__PURE__ */ reactExports.cloneElement(element, _objectSpread$1(_objectSpread$1(_objectSpread$1({}, item.props), itemEvents), {}, {
                activeIndex
              })), null, null];
            }
      ...
      _defineProperty$1(_this, "renderCustomized", function(element, displayName, index) {
        return /* @__PURE__ */ reactExports.cloneElement(element, _objectSpread$1(_objectSpread$1({
    ...
    return _createClass$1(CategoricalChartWrapper2, [{
      ...
      value: function render() {
        ...
        var _this$props6 = this.props, children = _this$props6.children, className = _this$props6.className, width = _this$props6.width, height = _this$props6.height, style = _this$props6.style, compact = _this$props6.compact, title = _this$props6.title, desc = _this$props6.desc, others = _objectWithoutProperties$1(_this$props6, _excluded2);
  ...
  _defineProperty$1(CategoricalChartWrapper, "getDerivedStateFromProps", function(nextProps, prevState) {
    ...
    if (prevState.updateId === void 0) {
      ...
      return _objectSpread$1(_objectSpread$1(_objectSpread$1({}, defaultState2), {}, {
        updateId: 0
...
var getWorstScore = function getWorstScore2(row, parentSize, aspectRatio) {
  ...
  var _row$reduce = row.reduce(function(result, child) {
    ...
    min: Infinity,
    max: 0
  }), min2 = _row$reduce.min, max2 = _row$reduce.max;
